    ...
    if (urlStringBuilder != null){
      ...
      try{
        ...
        try {
          ...
          if ((Utils.isRemoteFailureDetected()) && (params.getTag().equals("init") == false))
            Log.e(LOG_TAG, "stocktaskservice: failure detected, using zero values for bid prices");
          else
          {
            if (isUpdate) {
          ...
          updateIntent.setAction(ACTION_DATA_UPDATED);
